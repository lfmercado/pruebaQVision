...
public class MailPage extends PageObject {
    ...
    public static final Target ATTACHFILE = Target.the("boton para abjuntar archivo").located(By.xpath("//div//div[@aria-label='Adjuntar archivos']"));
    ...
    public static final Target SENDMAIL = Target.the("enviar correo").located(By.xpath("//div//div//div[@aria-label='Enviar (Ctrl-Enter)']"));
